<x-app-layout>
    ...
    <div class="py-12">
        ...
        @endif
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="shadow-sm sm:rounded-lg grid grid-cols-5 gap-6">
        ...
        {{-- TODO: Add user Transactions to dashboard --}}
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-red-300">
