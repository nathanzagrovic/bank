    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-white mt-8">
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-[12px] text-left rtl:text-right tracking-wide font-bold">
                    <thead class="bg-black/20 uppercase font-bold">
                    <tr>
                    ...
                    @foreach($transactions as $transaction)
                        <tr class="border-b border-gray-600/10 font-normal tracking-wider {{ $loop->even ? 'bg-black/10' : 'bg-transparent'  }}">
                            <td class="px-6 py-2 uppercase font-bold">
                                {{ $transaction->type }}
                            </td>
                            <td class="px-6 py-2 {{ $transaction->type == 'deposit' ? 'text-green-600' : 'text-red-700'  }}">
